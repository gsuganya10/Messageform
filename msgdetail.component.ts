...
import { MsgDetailService } from './msgdetail.service';
import { Team } from 'D:/message-form/src/app/team';
import { Employee } from 'D:/message-form/src/app/employee';
import { Department } from 'D:/message-form/src/app/department';

@Component({
  selector: 'app-msgdetail',	
  templateUrl: './msgdetail.component.html',
  styleUrls: ['./msgdetail.component.css']
})
...
export class MsgdetailComponent implements OnInit {
  ...
  constructor(
          ...
          private teamMngService: MsgDetailService) { 
  }
  ngOnInit() {
